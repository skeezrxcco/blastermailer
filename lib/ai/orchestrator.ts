  ...
  if (isEmailComposition) {
    try {
      ...
      const contentResult = await generateAiText({
        ...
        system: [
          "You are a senior email campaign copywriter and newsletter art director.",
          ...
          "The HBS layout is fixed; you only provide high-quality content fields.",
          "Write premium, specific copy with strong hierarchy and no fluff.",
          "Image MUST be a publicly reachable HTTPS URL to a high-quality hero photo.",
          "Keep language consistent with the user's language.",
        ...
        prompt: [
          ...
          "",
          "Generate polished newsletter copy optimized for modern campaigns.",
          "Subject: benefit-driven and concise (usually <= 60 chars).",
          "Title: 4-10 words with editorial punch.",
          "Subtitle: one sentence that sharpens the value proposition.",
          "Content: 2-4 short paragraphs separated by blank lines; include concrete outcomes, not generic claims.",
          "CTA: 2-5 words with a clear action and outcome.",
          "Image: provide a direct HTTPS image URL (prefer Unsplash/Pexels style hero images).",
          "If the user asked for branding/colors, include optional color keys with accessible contrast.",
          "Apply modern newsletter best practices: dark-mode-friendly palette, clear visual rhythm, and conversion-first messaging.",
